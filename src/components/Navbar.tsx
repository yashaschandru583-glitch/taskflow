...
export const Navbar: React.FC<NavbarProps> = ({ onToggleMobileSidebar, activePage, setActivePage }) => {
  ...
  return (
    <header id="app-navbar" className="h-20 bg-slate-900 border-b border-slate-800 sticky top-0 z-30 px-6 sm:px-10 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden sm:flex items-center gap-2.5 text-slate-100 font-bold text-base">
          <div className="w-8 h-8 rounded-xl bg-indigo-600 flex items-center justify-center text-white font-black text-sm shadow-sm shadow-indigo-500/20">
            T
          </div>
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs sm:text-sm font-bold px-5 py-2.5 rounded-full shadow-lg shadow-indigo-500/20 transition-all active:scale-95"
        >
        ...
        <div className="relative">
          ...
          >
            {user?.avatar ? (
              ...
              <div className="w-9 h-9 rounded-full bg-indigo-950 text-indigo-400 border border-indigo-800 font-black flex items-center justify-center text-xs">
          ...
          {isDropdownOpen && (
            <>
              ...
              <div
                ...
                className="absolute right-0 mt-2 w-56 bg-slate-900 rounded-2xl shadow-2xl border border-slate-800 py-2 z-50 text-sm text-slate-200"
              >
                ...
                <div className="py-1">
                  <button
                    ...
                    className="w-full flex items-center gap-2.5 px-4 py-2 text-left hover:bg-slate-800 text-slate-300 hover:text-white font-semibold text-xs"
                  >
                ...
                <div className="border-t border-slate-800 pt-1">
                  <button
                    ...
                    className="w-full flex items-center gap-2.5 px-4 py-2 text-left text-rose-400 hover:bg-rose-950/40 font-bold text-xs"
                  >
